...
public class Product implements Serializable {
    ...
    public String toString() {
        return "Id: "+ id + " | Tên sản phẩm: "+ nameProduct +  " | Giá bán: "+ getPrice() + "$"+" | Danh mục: "+ category.getNameCtategory() +" | Mô tả: "+description+ " | Số lượng kho: "+ stock + " | Hãng: " + manufacturer+ " | Trạng thái: "+ (status?"Còn hàng":"Hết hàng");
    }
}
