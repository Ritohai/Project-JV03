...
public class OrderManager {
    ...
    public void showUserOrder(){
        ...
        if(list.isEmpty()) {
            System.out.println("Đơn hàng rỗng");
            return;
        }
        for (Order o : list) {
...
//    }
    ...
    public void showOrderDetail() {
        ...
        System.out.println("\033[0;35mTổng : " + order.getTotal() + "$");
        System.out.println("\033[0;34m------------------------Kết thúc------------------------------");
        if (order.getStatus() == 0) {
            System.out.println("╔════════════════════════════════════════╗");
            System.out.println("║  Bạn có muốn hủy đơn đặt hàng này?     ║");
            System.out.println("╠════╦═══════════════════════════════════╣");
